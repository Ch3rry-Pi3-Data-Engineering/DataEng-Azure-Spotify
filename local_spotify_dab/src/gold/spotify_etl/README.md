...
This folder defines all source code for the 'spotify_etl' pipeline:
...
* Take a look at the sample under "sample_users_spotify_etl.py" to get familiar with the syntax.
